...
public class DataLoader implements ApplicationRunner{
	...
	public void run(ApplicationArguments args) throws Exception {
		System.out.println("--------------RunnerTest Start---------------------");
/*		
		repo.deleteAll();
		...
		c2.setDenailReason("Rent Income");	
		...
		List<CitizenPlan> lst = Arrays.asList(c1,c2,c3,c4,c5,c6,c7, c8,c9,c10,c11,c2);
		repo.saveAll(lst);
		
		*/
		System.out.println("--------------RunnerTest End---------------------");
	}
}
